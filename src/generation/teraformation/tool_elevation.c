...
void change_iso_point_up(window_t *window, int x, int y, map_node_t **map2d)
{
	int new_z = 0;
...
void tool_elevate_zone(window_t *window, int x, int y, map_node_t **map2d)
{
	...
	if (x + 2 > new_input.len_x || y + 2 > new_input.len_y)
		return;
	change_iso_point_up(window, x, y, map2d);
	change_iso_point_up(window, x + 1, y, map2d);
	change_iso_point_up(window, x, y + 1, map2d);
	change_iso_point_up(window, x + 1, y + 1, map2d);
